    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rate', models.DecimalField(decimal_places=2, default=1, max_digits=10, verbose_name='Курс')),
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('from_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='from_user', to=settings.AUTH_USER_MODEL, verbose_name='ОТ')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.DecimalField(decimal_places=2, default=0, max_digits=10, verbose_name='Сумма')),
                ('rate', models.DecimalField(decimal_places=2, default=1, max_digits=10, verbose_name='Курс')),
                ('total', models.DecimalField(decimal_places=2, default=1, max_digits=10, verbose_name='Итоговая сумма')),
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
